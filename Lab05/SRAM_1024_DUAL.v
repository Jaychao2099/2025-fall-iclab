...
module SRAM_1024_DUAL (A0,A1,A2,A3,A4,A5,A6,A7,A8,A9,B0,B1,B2,B3,B4,B5,
                       B6,B7,B8,B9,DOA0,DOA1,DOA2,DOA3,DOA4,DOA5,DOA6,
                       DOA7,DOB0,DOB1,DOB2,DOB3,DOB4,DOB5,DOB6,
                       DOB7,DIA0,DIA1,DIA2,DIA3,DIA4,DIA5,DIA6,
                       DIA7,DIB0,DIB1,DIB2,DIB3,DIB4,DIB5,DIB6,
                       DIB7,WEAN,WEBN,CKA,CKB,CSA,CSB,OEA,OEB);
  ...
  parameter  Tr2w                 = (154:223:365);    
  parameter  Tw2r                 = (126:178:287);    
  parameter  TOH                  = (51:74:122);      
...
`protect
  ...
  function AddressRangeCheck;
   ...
   specify
      specparam TAA  = (107:156:263);
      specparam TRC  = (154:223:365);
      specparam THPW = (51:74:122);
      specparam TLPW = (51:74:122);
      specparam TAS  = (46:69:116);
      specparam TAH  = (9:12:19);
      specparam TWS  = (26:37:61);
      specparam TWH  = (4:7:13);
      specparam TDS  = (16:26:47);
      specparam TDH  = (0:0:0);
      specparam TCSS = (52:79:134);
      specparam TCSH = (0:0:0);
      specparam TOE  = (60:87:140);
      specparam TOZ  = (39:55:89);
