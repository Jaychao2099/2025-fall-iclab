...
(iopad
    ...
    (left
        ...
        (inst  name="O_WORST_DELAY_0" place_status=placed)
        (inst  name="O_WORST_DELAY_1" place_status=placed)
    ...
    (bottom
        ...
        (inst  name="VDDC22"          place_status=placed)
        (inst  name="GNDC22"          place_status=placed)
        (inst  name="O_WORST_DELAY_2" place_status=placed)
        (inst  name="O_WORST_DELAY_3" place_status=placed)
        ...
        (inst  name="O_WORST_DELAY_4" place_status=placed)
        (inst  name="O_WORST_DELAY_5" place_status=placed)
        (inst  name="O_WORST_DELAY_6" place_status=placed)
        (inst  name="O_WORST_DELAY_7" place_status=placed)
        ...
        (inst  name="VDDC23"          place_status=placed)
        (inst  name="GNDC23"          place_status=placed)
    ...
    (right
        ...
        (inst  name="O_WORST_PATH_0" place_status=placed)
        (inst  name="O_WORST_PATH_1" place_status=placed)
        ...
        (inst  name="O_WORST_PATH_2" place_status=placed)
        (inst  name="O_WORST_PATH_3" place_status=placed)
